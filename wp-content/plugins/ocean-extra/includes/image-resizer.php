...
/**
 * Delete custom resized images when an attachment is deleted
 */
function oe_delete_custom_resized_images($post_id) {
	...
	// Find and delete custom resized images
	$custom_images = glob("{$dir}/{$filename}-*x*.{$extension}");
...
add_action('delete_attachment', 'oe_delete_custom_resized_images');
